...
import lawImage from '../Assets/lawjpg.jpg'; // Adjust the path as necessary
...
const BlogPage = () => {
  const blogs = [
    {
      ...
      imageUrl: lawImage, // Use the imported image
      date: '2024-08-01',
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8" style={{ fontFamily: 'Roboto, sans-serif' }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {blogs.map((blog) => (
          <div key={blog.id} className="bg-white rounded-lg shadow-lg p-6 transition-transform transform hover:scale-105 hover:shadow-xl">
            <div className="mb-4">
              <img
                src={blog.imageUrl}
                alt={blog.title}
            ...
            <div className="mb-2">
              <h2 className="text-2xl font-bold text-gray-800 hover:text-blue-600 transition-colors">{blog.title}</h2>
            </div>
